...
static void panelLan_rgb_spi_init() {
  ...
  spi_device_interface_config_t devcfg = {
    ...
    .spics_io_num = -1,  // CRITICAL FIX 1: Must be -1 to prevent Pin 38 from corrupting your Octal PSRAM
    .queue_size = 7,                       
  };
  ...
  // CRITICAL FIX 2: Manually unlock the pins so the RGB DMA engine can claim them!
  // Without these two lines, Panel_RGB::init() fails silently and causes the 0x00000000 crash.
